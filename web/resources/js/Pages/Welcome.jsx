          ...
          <div className="glass-panel p-10 max-w-2xl w-full flex flex-col items-center gap-6 border border-border-subtle rounded-xl shadow-glass bg-surface-secondary">
            ...
            <div className="mt-8 pt-8 border-t border-border-subtle w-full">
              ...
              <div className="flex justify-center gap-3 flex-wrap">
                ...
                <a href="/auth/facebook/redirect" className="flex items-center gap-2 bg-[#1877F2] text-white px-6 py-2 rounded-full text-sm font-semibold hover:bg-[#166FE5] transition-colors focus:ring-2 focus:ring-accent-primary focus:outline-none">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                  Facebook
                </a>
                <a href="/auth/line/redirect" className="flex items-center gap-2 bg-[#06C755] text-white px-6 py-2 rounded-full text-sm font-semibold hover:bg-[#05b34c] transition-colors focus:ring-2 focus:ring-accent-primary focus:outline-none">
            ...
            <div className="bg-surface-secondary border border-border-default rounded-xl shadow-xl w-full max-w-md p-6 flex flex-col gap-6 relative">
              ...
              <div className="flex flex-col gap-3 mt-2">
                ...
                <a 
                  ...
                  className="flex items-center justify-center gap-3 bg-[#1877F2] hover:bg-[#166FE5] text-white font-semibold py-3 px-4 rounded-lg transition-all focus:ring-2 focus:ring-accent-primary focus:outline-none"
                ...
                <a 
                  ...
                  className="flex items-center justify-center gap-3 bg-[#06C755] hover:bg-[#05b34c] text-white font-semibold py-3 px-4 rounded-lg transition-all focus:ring-2 focus:ring-accent-primary focus:outline-none"
                  id="modal-line-auth"
                >
